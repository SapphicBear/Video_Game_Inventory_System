...
INSERT INTO game_consoles (name, company, release_year)
    VALUES 
        ...
        ('All Platforms', 'Multiple Companies', null);
...
INSERT INTO games (name, studio_id, console_id, genre, release_year)
    VALUES (
        'Fallout: New Vegas', 
        (SELECT studio_id FROM game_studios WHERE name = 'Obsidian Entertainment'),
        (SELECT console_id FROM game_consoles WHERE name = 'All Platforms'),
        'RPG',
        '2010'
        );
`;
